...
var makeObstacles = function() {
    ...
    viableWeapons = [
        new GunStats('Glock 17', 35, false, 780, 1, 15, 1100, true, 40, 17, 4, 500, 150, 1000, 0.15, 0.12, 0.9, 7, 0.9, 0.95, 1, '#80f','bullet','#ff0', 60, 35, 5, 0, 0, 0),
        new GunStats('Redhawk', 40, false, 300, 1, 6, 1400,true, 50, 33, 8, 750, 200, 1500, 0, 0.2, 0.9, 10, 0.9, 0.95, 0.6, '#ff0','bullet','#ff0', 60,35, 5, 0, 0, 0),
