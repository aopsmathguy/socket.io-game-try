...
const viableWeapons = {
    ...
    start : function()
    {
        this.weapons = [
            ...
            new GunStats('Mosin Nagant', 130, false, 55, 1, 5, 1000, false, 70, 70, 20, 830, 240, 2500, 0, 0.3, 0.83, 14, 0.9, 0.9, 0.6, '#8f0', 'bullet','#ff0',8,60,4,28, 3, 53, -2),
            new GunStats('M200', 140, false, 30, 1, 7, 3500, true, 80, 110, 20, 300, 100, 2500, 0, 0.3, 0.83, 16, 0.9, 0.9, 0.6, '#88f', 'bullet','#ff0',10,60,4,28, 3, 53, -2),
            ...
            new GunStats('M870', 105, false, 70, 8, 5, 1000, false, 35, 16, 8, 400, 88, 800, 0.14, 0, 0.83, 10, 0.9, 1, 0.5, '#8f8', 'bullet','#ff0',4,60,4,28, 3, 53, -2),
            new GunStats('SPAS-12', 110, false, 100, 8, 9, 800, false, 40, 8, 1, 650, 100, 1100, 0.1, 0, 0.83, 10, 0.9, 0.95, 0.3, '#0ff', 'bullet','#ff0',4,60,4,28, 3, 53, -2)
        ];
    }
};
