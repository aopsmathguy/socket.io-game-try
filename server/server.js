    ...
    this.update = function()
    {
        ...
        else if (player && player.alive)
        {
            ...
            for (var i in trimmedGameState.players){
                if (this.state.players[i].pos.distanceTo(player.pos) < 200 || !underCover(this.state.players[i].pos) || this.state.minimapInfo[i]){
                    visible.push(i);
                }
            }
...
const constants = {
    ...
    start : function()
    {
        this.weapons = [
            ...
            new GunStats('Stevens DB', 'Shotgun', 90, 1, 450, 8, 2, 2200, true, 26.25, 15, 10, 350, 56, 525, 0.2, 0, 0.83, 10, 0.9, 1.5,1, 0.9, '#888', 'bullet',0,4,60,2,30, 3, 53, -2),
            new GunStats('M870', 'Shotgun', 105, 1, 80, 8, 5, 870, false, 26.25, 16, 12, 400, 88, 600, 0.19, 0, 0.83, 10, 0.9, 1.5,1, 0.8, '#555', 'bullet',0,4,60,4,28, 3, 57, -2),
            new GunStats('SPAS-12', 'Shotgun', 110, 1, 120, 8, 9, 750, false, 30, 9, 1, 650, 100, 825, 0.12, 0, 0.83, 10, 0.9, 1.5,0.95, 0.6, '#333', 'bullet',0,4,60,4,28, 3, 58, -2),

            new GunStats('MAC-10', 'SMG', 50, Infinity, 1200, 1, 32, 1600, true, 26.25, 16, 10, 300, 150, 637.5, 0.1, 0.06, 0.9, 3, 0.9, 0.4, 0.97, 0.8, '#333','bullet', 1,5,60,3,26, 3, 40, -2),
            new GunStats('MP5', 'SMG',75, Infinity, 750, 1, 30, 1900, true, 33.75, 16, 8, 400, 270, 825, 0, 0.07, 0.91, 4, 0.9, 0.4, 0.95, 0.65, '#333','bullet', 1,5,60,4,26, 3, 51, -2),
            new GunStats('M1A1', 'SMG',90, Infinity, 720, 1, 50, 3100, true, 28, 17, 10, 450, 300, 900, 0, 0.04, 0.96, 5, 0.9, 0.3, 0.9, 0.5, '#333', 'bullet', 2,5,60,3,23, 3,48, -9),

            new GunStats('AK-47', 'Assault',95, Infinity, 600, 1, 30, 2500, true, 41.25, 21, 6, 570, 400, 1100, 0, 0.2, 0.85, 6, 0.9, 0.48, 0.93, 0.5, '#333', 'bullet',4,6,60,3, 28, 3, 60, -2),
            new GunStats('M4A1', 'Assault', 90, Infinity, 720, 1, 30, 2200, true, 45, 14, 1, 550, 270, 975, 0, 0.07, 0.9, 5, 0.9, 0.48, 0.93, 0.5, '#333', 'bullet',3,6,60,0,30, 3,55, -2),
            new GunStats('M4', 'Assault', 90, 3, 950, 1, 30, 2200, true, 45, 14, 1, 550, 270, 975, 0, 0.03, 0.95, 5, 0.9, 0.48, 0.93, 0.5, '#333', 'bullet',3,6,60,0,30, 3,55, -2),

            new GunStats('MK12 SPR', 'DMR',102, 1, 550, 1, 15, 2600, true, 45, 26, 6, 710, 500, 1200, 0, 0.3, 0.83, 8, 0.84, 0.56, 0.92, 0.5, '#333', 'bullet',3,6,90,0,28, 3, 60, -2),

            new GunStats('Remington 700','Sniper', 112, 1, 80, 1, 5, 3000, true, 52.5, 70, 20, 830, 240, 1875, 0, 0.3, 0.83, 14, 0.9, 2.5, 0.9, 0.7, '#333', 'bullet',5,8,170,4,28, 3, 60, -2),
            new GunStats('AWP', 'Sniper',125, 1, 65, 1, 3, 2000, true, 60, 106, 40, 400, 100, 1875, 0, 0.3, 0.83, 16, 0.9, 3, 0.9, 0.6, '#333', 'bullet',5,10,200,4,28, 3, 60, -2),
            ...
            new GunStats('Laser', 'Other',90, 1, 120, 1, 6, 500, false,100, 40, 6, 700, 200, 2500, 0, 0, 0.91, 20, 0.9, 0, 0.9, 0.4, '#f00','laser',6, 6,60,4,30, 3, 58, -2)
        ];
        this.structures = [
            new Structure(
              "rock",
...
var Bullet = function(weapon) {
    ...
    var ang = weapon.ang + 0.75 * weapon.spray * invcdf(Math.random());
