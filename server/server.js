...
var makeObstacles = function () {
  ...
  var viableWeapons = [
    ...
    new Gun(200, 50, 60, false, 550, 1, 15, 1600, 50, 26, 3, 710, 200, 2000, 0, 0.3, 0.83, 6, 0.84, 0.9, 0.5, '#00f',20,3,45,6),
    
    new Gun(200, 350, 90, true, 700, 1, 50, 5000, 45, 7, 1, 550, 270, 1500, 0, 0.08, 0.91, 3, 0.9, 0.7, 0.2, '#fff',20,3,45,6),
    new Gun(200, 350, 90, true, 1500, 1, 100, 5000, 200, 3, 0, 550, 270, 2000, 0, 0, 0.91, 3, 0.9, 0.7, 0.2, '#0f0',20,3,45,6),
