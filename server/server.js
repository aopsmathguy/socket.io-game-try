...
var makeObstacles = function() {
    ...
    var viableWeapons = [
        new Gun('M9',100, 50, 30, false, 780, 1, 15, 1000, 35, 17, 4, 500, 150, 1000, 0.1, 0.12, 0.9, 4, 0.9, 1, 1, '#80f', 20, 0, 20, 0),
        new Gun('Redhawk',100, 50, 35, false, 300, 1, 6, 1500, 48, 33, 8, 750, 200, 1500, 0, 0.2, 0.9, 4, 0.9, 1, 0.6, '#ff0', 20, 3, 20, 3),

        new Gun('MAC-10',100, 50, 30, true, 900, 1, 32, 1200, 35, 10, 5, 500, 150, 1000, 0, 0.12, 0.9, 3, 0.9, 1, 0.8, '#f00', 20, 3, 35, 6),
        new Gun('MP5',200, 350, 50, true, 600, 1, 30, 1500, 42, 10, 2, 550, 270, 1500, 0, 0.08, 0.91, 3, 0.9, 0.9, 0.6, '#f80', 20, 3, 40, 6),
        new Gun('MK11',200, 50, 60, false, 550, 1, 15, 1600, 60, 26, 3, 710, 200, 2000, 0, 0.3, 0.83, 6, 0.84, 0.9, 0.5, '#f08', 20, 3, 45, 6),

        new Gun('QBB-97',200, 350, 70, true, 700, 1, 75, 4500, 45, 10, 2, 550, 270, 1500, 0, 0.08, 0.91, 3, 0.9, 0.7, 0.4, '#fff', 20, 3, 45, 6),
        new Gun('Railgun',200, 350, 90, true, 1500, 1, 100, 2000, 100, 5, 0, 550, 270, 2000, 0, 0, 0.91, 3, 0.9, 0.9, 0.3, '#08f', 20, 3, 45, 6),

        new Gun('Scout',200, 50, 70, false, 70, 1, 5, 2400, 70, 70, 20, 830, 240, 3000, 0, 0.3, 0.83, 12, 0.9, 0.8, 0.6, '#8f0', 20, 3, 45, 6),
        new Gun('BFG',200, 50, 90, false, 40, 1, 1, 3000, 90, 101, 0, 830, 240, 5000, 0, 0.3, 0.83, 15, 0.9, 0.7, 0.5, '#000', 20, 3, 50, 6),

        new Gun('Stevens DB',200, 220, 35, false, 450, 8, 2, 1600, 30, 15, 9, 350, 56, 700, 0.15, 0, 0.83, 6, 0.9, 1, 0.7, '#f0f', 20, 3, 40, 6),
        new Gun('SPAS-12',200, 220, 50, false, 100, 8, 6, 1750, 40, 8, 1, 650, 100, 1300, 0.10, 0, 0.83, 6, 0.9, 1, 0.5, '#0ff', 20, 3, 40, 6)
    ];
