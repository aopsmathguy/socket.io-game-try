...
var makeObstacles = function() {
    ...
    var viableWeapons = [
        ...
        new Gun(100, 50, 35, false, 300, 1, 6, 1500, 48, 33, 8, 750, 200, 1500, 0, 0.2, 0.9, 4, 0.9, 1, 0.6, '#ff0', 20, 3, 20, 3),
        ...
        new Gun(200, 220, 50, false, 100, 8, 6, 1750, 40, 8, 3, 650, 100, 1300, 0.10, 0, 0.83, 6, 0.9, 1, 0.5, '#0ff', 20, 3, 40, 6)
    ];
