...
var Bot = function(state)
{
    ...
    this.keyUpdatePeriod = 1 + 1*Math.random();
...
const viableWeapons = {
    ...
    {
        this.weapons = [
            new GunStats('Glock 17', 'Secondary', 35, 1, 780, 1, 15, 1500, true, 30, 20, 4, 500, 150, 1000, 0.15, 0.12, 0.9, 7, 0.9, 0, 0.95, 1, '#80f','bullet','#fc8', 5, 60, 32, 3, 0, 3, 0),
            new GunStats('Glock 18', 'Secondary', 35, Infinity, 780, 1, 17, 1500, true, 30, 17, 7, 500, 150, 1000, 0.15, 0.09, 0.9, 7, 0.9, 0, 0.95, 1, '#444','bullet','#fc8', 5, 60, 32, 3, 0, 3, 0),
            new GunStats('Redhawk', 'Secondary', 40, 1, 300, 1, 6, 1700,true, 50, 30, 10, 700, 200, 1300, 0, 0.2, 0.9, 10, 0.9, 0.5, 0.95, 0.6, '#ff0','bullet','#bbf', 5, 60,32, 3, 0, 3, 0),
            new GunStats('Executioner', 'Secondary', 35, 1, 450, 14, 6, 2900,true, 22.5, 5, 3.5, 330, 200, 600, 0.2, 0, 0.9, 10, 0.9, 0.5, 0.95, 0.6, '#088','bullet','#f88', 3, 60,32, 3, 0, 3, 0),
            
            new GunStats('Stevens DB', 'Shotgun', 90, 1, 450, 8, 2, 2300, true, 26.25, 15, 10, 350, 56, 700, 0.16, 0, 0.83, 10, 0.9, 1.5,1, 0.7, '#f0f', 'bullet','#f88',4,60,2,30, 3, 53, -2),
            new GunStats('M870', 'Shotgun', 105, 1, 60, 8, 5, 1000, false, 26.25, 16, 12, 400, 88, 800, 0.15, 0, 0.83, 10, 0.9, 1.5,1, 0.3, '#8f8', 'bullet','#f88',4,60,4,28, 3, 57, -2),
            new GunStats('SPAS-12', 'Shotgun', 110, 1, 100, 8, 9, 800, false, 30, 9, 1, 650, 100, 1100, 0.1, 0, 0.83, 10, 0.9, 1.5,0.95, 0.3, '#0ff', 'bullet','#f88',4,60,4,28, 3, 58, -2),
            
            new GunStats('MAC-10', 'SMG', 50, Infinity, 1200, 1, 32, 1600, true, 26.25, 16, 10, 340, 150, 850, 0.1, 0.06, 0.9, 3, 0.9, 0.4, 0.97, 0.8, '#08f','bullet', '#fc8',5,60,12,22, 3, 40, -2),
            new GunStats('MP5', 'SMG',75, Infinity, 750, 1, 30, 1900, true, 33.75, 16, 8, 500, 270, 1100, 0, 0.07, 0.91, 4, 0.9, 0.4, 0.95, 0.65, '#f80','bullet', '#fc8',5,60,6,26, 3, 51, -2),
            new GunStats('M1A1', 'SMG',90, Infinity, 700, 1, 50, 3100, true, 33.75, 15, 5, 550, 270, 1200, 0, 0.04, 0.96, 5, 0.9, 0.3, 0.9, 0.5, '#fff', 'bullet','#ff8',5,60,10,23, 3,48, -9),
            
            new GunStats('AK-47', 'Assault',95, Infinity, 600, 1, 30, 2500, true, 41.25, 15, 2, 600, 400, 1300, 0, 0.15, 0.85, 6, 0.9, 0.48, 0.93, 0.5, '#bb7554', 'bullet','#bbf',6,60,8, 24, 3, 50, -2),
            new GunStats('M4A1', 'Assault', 90, Infinity, 700, 1, 30, 3000, true, 45, 17, 1, 650, 270, 1300, 0, 0.07, 0.9, 5, 0.9, 0.48, 0.93, 0.5, '#888', 'bullet','#8f8',6,60,12,20, 3,45, -2),
            new GunStats('M4', 'Assault', 90, 3, 900, 1, 30, 2600, true, 45, 20, 2, 460, 200, 1300, 0, 0.035, 0.95, 5, 0.9, 0.48, 0.93, 0.5, '#ccc', 'bullet','#8f8',6,60,12,20, 3,45, -2),

            new GunStats('MK11', 'DMR',90, 1, 550, 1, 15, 2600, true, 45, 26, 6, 710, 500, 1600, 0, 0.3, 0.83, 8, 0.84, 0.56, 0.92, 0.5, '#f08', 'bullet','#bbf',6,60,12,20, 3, 45, -2),

            new GunStats('Mosin Nagant','Sniper', 130, 1, 55, 1, 5, 1000, false, 52.5, 70, 20, 830, 240, 2500, 0, 0.3, 0.83, 14, 0.9, 2.5, 0.9, 0.6, '#8f0', 'bullet','#f8f',8,60,4,28, 3, 60, -2),
            new GunStats('M200', 'Sniper',140, 1, 40, 1, 7, 3500, true, 60, 106, 40, 400, 100, 2500, 0, 0.3, 0.83, 16, 0.9, 3, 0.9, 0.6, '#88f', 'bullet','#f8f',10,60,4,28, 3, 60, -2),
