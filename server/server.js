...
var makeObstacles = function() {
    ...
    viableWeapons = [
        new GunStats('Glock 17', 35, false, 780, 1, 15, 1500, true, 40, 17, 4, 500, 150, 1000, 0.15, 0.12, 0.9, 7, 0.9, 0.95, 1, '#80f','bullet','#ff0', 60, 35, 3, 0, 3, 0),
        new GunStats('Redhawk', 40, false, 300, 1, 6, 1700,true, 50, 33, 8, 750, 200, 1300, 0, 0.2, 0.9, 10, 0.9, 0.95, 0.6, '#ff0','bullet','#ff0', 60,35, 3, 0, 3, 0),

        new GunStats('MAC-10', 50, true, 1200, 1, 32, 1600, true, 35, 10, 5, 400, 150, 850, 0.1, 0.06, 0.9, 3, 0.9, 0.97, 0.8, '#08f','bullet', '#ff0',60,20,10, 3, 27, -2),
        new GunStats('MP5', 75, true, 750, 1, 30, 1900, true, 45, 11, 4, 550, 270, 1100, 0, 0.07, 0.91, 4, 0.9, 0.95, 0.65, '#f80','bullet', '#ff0',60,14,26, 3, 46, -2),
        new GunStats('AK-47', 95, true, 600, 1, 30, 2400, true, 55, 12, 2, 600, 400, 1300, 0, 0.15, 0.85, 6, 0.9, 0.93, 0.5, '#bb7554', 'bullet','#ff0',60,16, 24, 3, 50, -2),
        new GunStats('MK11', 90, false, 550, 1, 15, 2600, true, 70, 26, 7, 710, 200, 1600, 0, 0.3, 0.83, 8, 0.84, 0.92, 0.5, '#f08', 'bullet','#ff0',60,20,20, 3, 45, -2),
        new GunStats('M1A1', 90, true, 700, 1, 50, 3100, true, 45, 11, 3, 550, 270, 1200, 0, 0.04, 0.96, 5, 0.9, 0.9, 0.5, '#fff', 'bullet','#ff0',60,12,28, 3,48, -9),
        new GunStats('M16A3', 90, true, 700, 1, 30, 3000, true, 60, 12, 1, 650, 270, 1300, 0, 0.07, 0.9, 5, 0.9, 0.93, 0.5, '#888', 'bullet','#ff0',60,20,20, 3,45, -2),
        
        
        new GunStats('Laser', 90, false, 120, 1, 6, 2700, true,200, 50, 1, 700, 200, 2000, 0, 0, 0.91, 20, 0.9, 0.9, 0.4, '#f00','laser','#f00', 120,20,20, 3, 45, -2),

        new GunStats('Mosin Nagant', 110, false, 60, 1, 5, 1300, false, 70, 70, 20, 830, 240, 2500, 0, 0.3, 0.83, 14, 0.9, 0.9, 0.6, '#8f0', 'bullet','#ff0',60,20,20, 3, 45, -2),
        new GunStats('Crossbow', 70, false, 9000, 1, 1, 1500, false,25, 100, 0, 830, 240, 1500, 0, 0.3, 0.83, 16, 0.9, 0.9, 1, '#000', 'arrow','#bb7554', 30,20,20, 3, 40, -2),

        new GunStats('Stevens DB', 90, false, 450, 8, 2, 2000, true, 35, 15, 9, 350, 56, 700, 0.15, 0, 0.83, 10, 0.9, 1, 0.7, '#f0f', 'bullet','#ff0',60,10,30, 3, 53, -2),
        new GunStats('SPAS-12', 70, false, 100, 8, 9, 1000, false, 40, 8, 1, 650, 100, 1100, 0.1, 0, 0.83, 10, 0.9, 1, 0.5, '#0ff', 'bullet','#ff0',60,20,20, 3, 40, -2)
    ];
