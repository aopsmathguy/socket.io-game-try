...
const viableWeapons = {
    ...
    start : function()
    {
        this.weapons = [
            ...
            new GunStats('Crossbow', 'Other',70, false, 9000, 1, 1, 2400, false,18.75, 100, 0, 830, 240, 1500, 0, 0.3, 0.83, 14, 0.9, 3, 0.9, 1, '#000', 'arrow','#ff9f73',10,60,12,20, 3, 40, -2),
            new GunStats('Laser', 'Other',90, false, 120, 1, 6, 2700, true,200, 40, 6, 700, 200, 2500, 0, 0, 0.91, 20, 0.9, 0, 0.9, 0.4, '#f00','laser','#f00', 6,60,12,20, 3, 45, -2)
        ];
    }
};
