...
const viableWeapons = {
    ...
    start : function()
    {
        this.weapons = [
            ...
            new GunStats('Redhawk', 'Secondary', 40, 1, 300, 1, 6, 1700,true, 50, 30, 10, 700, 200, 1300, 0, 0.2, 0.9, 10, 0.9, 0.5, 0.95, 0.6, '#ff0','bullet','#88f', 5, 60,32, 3, 0, 3, 0),
            ...
            new GunStats('AK-47', 'Assault',95, Infinity, 600, 1, 30, 2500, true, 41.25, 15, 2, 600, 400, 1300, 0, 0.15, 0.85, 6, 0.9, 0.48, 0.93, 0.5, '#bb7554', 'bullet','#88f',6,60,8, 24, 3, 50, -2),
            ...
            new GunStats('MK11', 'DMR',90, 1, 550, 1, 15, 2600, true, 45, 26, 6, 710, 500, 1600, 0, 0.3, 0.83, 8, 0.84, 0.56, 0.92, 0.5, '#f08', 'bullet','#88f',6,60,12,20, 3, 45, -2),
