...
var makeObstacles = function() {
    ...
    var viableWeapons = [
        ...
        new Gun('AK-47',200, 350, 60, true, 600, 1, 30, 1600, true, 55, 14, 2, 600, 400, 1500, 0, 0.13, 0.85, 6, 0.9, 0.9, 0.5, '#DEB887', 20, 3, 45, 6),
        new Gun('MK11',200, 50, 65, false, 550, 1, 15, 1800, true, 70, 26, 7, 710, 200, 2000, 0, 0.3, 0.83, 8, 0.84, 0.85, 0.5, '#f08', 20, 3, 45, 6),

        new Gun('QBB-97',200, 350, 70, true, 550, 1, 75, 3000, true, 55, 15, 5, 550, 270, 1500, 0, 0.04, 0.96, 5, 0.9, 0.8, 0.5, '#fff', 20, 3, 45, 6),
        new Gun('Railgun',200, 350, 90, true, 1500, 1, 100, 2000, true, 100, 7, 0, 550, 270, 2000, 0, 0, 0.91, 2, 0.9, 0.85, 0.4, '#08f', 20, 3, 45, 6),

        new Gun('Mosin Nagant',200, 50, 70, false, 60, 1, 5, 1000, false, 70, 70, 20, 830, 240, 3000, 0, 0.3, 0.83, 14, 0.9, 0.9, 0.6, '#8f0', 20, 3, 45, 6),
        ...
        new Gun('SPAS-12',200, 220, 50, false, 100, 8, 9, 800, false, 40, 8, 1, 650, 100, 1100, 0.1, 0, 0.83, 10, 0.9, 1, 0.5, '#0ff', 20, 3, 40, 6)
    ];
