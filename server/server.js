...
var makeObstacles = function() {
    ...
    viableWeapons = [
        ...
        new GunStats('MP5', 75, true, 750, 1, 30, 1450, true, 45, 11, 4, 550, 270, 1100, 0, 0.07, 0.91, 4, 0.9, 0.95, 0.65, '#f80','bullet', '#ff0',60,14,26, 3, 46, 0),
        ...
        new GunStats('M16A3', 90, true, 700, 1, 30, 2500, true, 60, 12, 1, 650, 270, 1300, 0, 0.07, 0.9, 5, 0.9, 0.93, 0.5, '#888', 'bullet','#ff0',60,20,20, 3,45, 0),
