...
var makeObstacles = function() {
    ...
    viableWeapons = [
        ...
        new GunStats('M1A1', 100, true, 550, 1, 75, 3000, true, 55, 15, 5, 550, 270, 1500, 0, 0.04, 0.96, 5, 0.9, 0.85, 0.5, '#fff', 14,26, 3,51, 0),
        new GunStats('Railgun', 110, true, 100000000, 1, 200, 2000, true, 200, 1, 0, 550, 270, 2000, 0, 0, 0.91, 2, 0.9, 0.85, 0.4, '#08f', 20,20, 3, 45, 0),
