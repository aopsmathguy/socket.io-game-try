...
const viableWeapons = {
    ...
    start : function()
    {
        this.weapons = [
            ...
            new GunStats('MAC-10', 50, true, 1200, 1, 32, 1600, true, 35, 10, 5, 400, 150, 850, 0.1, 0.06, 0.9, 3, 0.9, 0.1, 0.97, 0.8, '#08f','bullet', '#ff0',5,60,12,27, 3, 27, -2),
            new GunStats('MP5', 75, true, 750, 1, 30, 1900, true, 45, 11, 4, 550, 270, 1100, 0, 0.07, 0.91, 4, 0.9, 0.1, 0.95, 0.65, '#f80','bullet', '#ff0',5,60,6,26, 3, 46, -2),
            new GunStats('AK-47', 95, true, 600, 1, 30, 2400, true, 55, 12, 2, 600, 400, 1300, 0, 0.15, 0.85, 6, 0.9, 0.12, 0.93, 0.5, '#bb7554', 'bullet','#ff0',6,60,8, 24, 3, 50, -2),
            new GunStats('MK11', 90, false, 550, 1, 15, 2600, true, 70, 26, 7, 710, 200, 1600, 0, 0.3, 0.83, 8, 0.84, 0.14, 0.92, 0.5, '#f08', 'bullet','#ff0',6,60,12,20, 3, 45, -2),
            new GunStats('M1A1', 90, true, 700, 1, 50, 3100, true, 45, 11, 3, 550, 270, 1200, 0, 0.04, 0.96, 5, 0.9, 0.1, 0.9, 0.5, '#fff', 'bullet','#ff0',5,60,4,28, 3,48, -9),
            new GunStats('M4A1', 90, true, 700, 1, 30, 3000, true, 60, 13, 1, 650, 270, 1300, 0, 0.07, 0.9, 5, 0.9, 0.12, 0.93, 0.5, '#888', 'bullet','#ff0',6,60,12,20, 3,45, -2),
