...
const viableWeapons = {
    ...
    start : function()
    {
        this.weapons = [
            ...
            new GunStats('Mosin Nagant','Sniper', 130, 1, 55, 1, 5, 1000, false, 52.5, 70, 20, 830, 240, 2500, 0, 0.3, 0.83, 14, 0.9, 2.5, 0.9, 0.6, '#8f0', 'bullet','#c8f',8,60,4,28, 3, 60, -2),
            new GunStats('M200', 'Sniper',140, 1, 40, 1, 7, 3500, true, 60, 106, 40, 400, 100, 2500, 0, 0.3, 0.83, 16, 0.9, 3, 0.9, 0.6, '#88f', 'bullet','#c8f',10,60,4,28, 3, 60, -2),
