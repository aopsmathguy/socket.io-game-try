...
const viableWeapons = {
    ...
    start : function()
    {
        this.weapons = [
            ...
            new GunStats('Redhawk', 40, false, 300, 1, 6, 1700,true, 50, 40, 10, 700, 200, 1300, 0, 0.2, 0.9, 10, 0.9, 0.5, 0.95, 0.6, '#ff0','bullet','#ff0', 5, 60,32, 3, 0, 3, 0),
            new GunStats('Executioner', 35, false, 450, 16, 6, 1900,true, 30, 5, 3, 330, 200, 600, 0.2, 0, 0.9, 10, 0.9, 0.5, 0.95, 0.6, '#088','bullet','#ff0', 3, 60,32, 3, 0, 3, 0),
            ...
            new GunStats('AK-47', 95, true, 600, 1, 30, 2400, true, 55, 12, 2, 600, 400, 1300, 0, 0.15, 0.85, 6, 0.9, 0.24, 0.93, 0.5, '#bb7554', 'bullet','#ff0',6,60,8, 24, 3, 50, -2),
            new GunStats('MK11', 90, false, 550, 1, 15, 2600, true, 70, 26, 7, 710, 200, 1600, 0, 0.3, 0.83, 8, 0.84, 0.28, 0.92, 0.5, '#f08', 'bullet','#ff0',6,60,12,20, 3, 45, -2),
            ...
            new GunStats('M4A1', 90, true, 700, 1, 30, 3000, true, 60, 13, 1, 650, 270, 1300, 0, 0.07, 0.9, 5, 0.9, 0.24, 0.93, 0.5, '#888', 'bullet','#ff0',6,60,12,20, 3,45, -2),
            ...
            new GunStats('M200', 140, false, 30, 1, 7, 3500, true, 80, 110, 20, 300, 100, 2500, 0, 0.3, 0.83, 16, 0.9, 3, 0.9, 0.6, '#88f', 'bullet','#ff0',10,60,4,28, 3, 60, -2),
            new GunStats('Crossbow', 70, false, 9000, 1, 1, 1500, false,25, 100, 0, 830, 240, 1500, 0, 0.3, 0.83, 14, 0.9, 3, 0.9, 1, '#000', 'arrow','#bb7554',10,30,12,20, 3, 40, -2),
            ...
            new GunStats('M870', 105, false, 70, 8, 5, 1000, false, 35, 16, 8, 400, 88, 800, 0.14, 0, 0.83, 10, 0.9, 1.5,1, 0.5, '#8f8', 'bullet','#ff0',4,60,4,28, 3, 57, -2),
            new GunStats('SPAS-12', 110, false, 100, 8, 9, 800, false, 40, 8, 1, 650, 100, 1100, 0.1, 0, 0.83, 10, 0.9, 1.5,0.95, 0.3, '#0ff', 'bullet','#ff0',4,60,4,28, 3, 58, -2)
        ];
    }
};
