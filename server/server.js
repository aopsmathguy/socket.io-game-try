...
var makeObstacles = function() {
    ...
    var viableWeapons = [
        ...
        new Gun('MAC-10',100, 50, 30, true, 900, 1, 32, 1200, 40, 10, 5, 500, 150, 1000, 0, 0.10, 0.9, 3, 0.9, 0.95, 0.8, '#f00', 20, 3, 35, 6),
        new Gun('MP5',200, 350, 50, true, 750, 1, 30, 1500, 45, 9, 2, 550, 270, 1500, 0, 0.06, 0.91, 4, 0.9, 0.9, 0.6, '#f80', 20, 3, 40, 6),
        new Gun('MK11',200, 50, 60, false, 550, 1, 15, 1600, 70, 26, 3, 710, 200, 2000, 0, 0.3, 0.83, 8, 0.84, 0.85, 0.5, '#f08', 20, 3, 45, 6),
        ...
        new Gun('AWM-S',200, 50, 90, false, 30, 1, 3, 3000, 40, 100, 0, 830, 240, 5000, 0, 0.3, 0.83, 17, 0.9, 0.8, 0.5, '#000', 20, 3, 50, 6),
...
var Gun = function(name, startX, startY, length, auto, firerate, multishot, capacity, reloadTime, bulletSpeed, damage, damageDrop, damageRange, damageDropTension, range, defSpray, sprayCoef, stability, kickAnimation, animationMult, walkSpeedMult, shootWalkSpeedMult, color, handPos1x, handPos1y, handPos2x, handPos2y) {
    ...
    this.pushFromAll = function(state)
    {
        ...
        state.loopThroughWeapons(this.pos, (weaponIdx) => {
            ...
            if (stretch > 0)
            {
                finalForce = finalForce.add((new Vector(0.03*stretch,0)).rotate(this.pos.angTo(weapon.pos)));
            }
        });
        loopThroughObstacles(this.pos, (obstacle) => {
            ...
            if (stretch > 0)
            {
                finalForce = finalForce.add((new Vector(0.06*stretch,0)).rotate(this.pos.angTo(closestPoint)));
            }
