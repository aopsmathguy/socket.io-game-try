...
var makeObstacles = function () {
  ...
  var viableWeapons = [
    ...
    new Gun(200, 220, 35, false, 450, 8, 2, 1250, 25, 13, 9, 350, 56, 700, 0.23, 0, 0.83, 6, 0.9, 0.5, '#808'),
    new Gun(200, 220, 40, true, 300, 6, 5, 1400, 25, 10, 7, 220, 36, 600, 0.3, 0, 0.83, 6, 0.9, 0.5, '#0ff')
  ];
  var numEach = [4,2,2,1,2,10];
   var weapons = [];
