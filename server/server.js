...
var makeObstacles = function() {
    ...
    var viableWeapons = [
        ...
        new Gun('Redhawk',100, 50, 35, false, 300, 1, 6, 1300, true, 50, 33, 8, 750, 200, 1500, 0, 0.2, 0.9, 10, 0.9, 0.95, 0.6, '#ff0', 20, 3, 20, 3),

        new Gun('MAC-10',100, 50, 30, true, 900, 1, 32, 1200, true, 45, 12, 6, 500, 150, 1000, 0, 0.10, 0.9, 3, 0.9, 0.97, 0.8, '#f00', 20, 3, 35, 6),
        new Gun('MP5',200, 350, 50, true, 720, 1, 30, 1300, true, 45, 11, 3, 550, 270, 1250, 0, 0.06, 0.91, 4, 0.9, 0.95, 0.65, '#f80', 20, 3, 40, 6),
        new Gun('AK-47',200, 350, 60, true, 600, 1, 30, 1600, true, 55, 13, 2, 600, 400, 1500, 0, 0.13, 0.85, 6, 0.9, 0.93, 0.5, '#DEB887', 30, 3, 50, 6),
        new Gun('MK11',200, 50, 65, false, 550, 1, 15, 1800, true, 70, 26, 7, 710, 200, 2000, 0, 0.3, 0.83, 8, 0.84, 0.92, 0.5, '#f08', 30, 3, 55, 6),

        new Gun('QBB-97',200, 350, 70, true, 550, 1, 75, 3000, true, 55, 15, 5, 550, 270, 1500, 0, 0.04, 0.96, 5, 0.9, 0.85, 0.5, '#fff', 30, 3, 50, 6),
        new Gun('Railgun',200, 350, 90, true, 1500, 1, 100, 2000, true, 100, 7, 0, 550, 270, 2000, 0, 0, 0.91, 2, 0.9, 0.85, 0.4, '#08f', 30, 3, 55, 6),

        new Gun('Mosin Nagant',200, 50, 70, false, 60, 1, 5, 1000, false, 70, 70, 20, 830, 240, 3000, 0, 0.3, 0.83, 14, 0.9, 0.9, 0.6, '#8f0', 30, 3, 50, 6),
        new Gun('Crossbow',200, 50, 40, false, 45, 1, 1, 1500, false, 25, 100, 0, 830, 240, 1500, 0, 0.3, 0.83, 17, 0.9, 0.9, 0.8, '#000', 30, 3, 50, 6),

        new Gun('Stevens DB',200, 220, 35, false, 450, 8, 2, 1600, true, 35, 15, 9, 350, 56, 700, 0.15, 0, 0.83, 10, 0.9, 1, 0.7, '#f0f', 30, 3, 50, 6),
        new Gun('SPAS-12',200, 220, 50, false, 100, 8, 9, 800, false, 40, 8, 1, 650, 100, 1100, 0.1, 0, 0.83, 10, 0.9, 1, 0.5, '#0ff', 30, 3, 50, 6)
    ];
