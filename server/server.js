...
const constants = {
    ...
    start : function()
    {
        this.weapons = [
            ...
            new GunStats('M4', 'Assault', 90, 3, 950, 1, 30, 2200, true, 45, 14, 1, 550, 270, 975, 0, 0.03, 0.95, 5, 0.9, 0.48, 0.93, 0.5, '#333', 'bullet',3,6,60,12,20, 3,45, -2),

            new GunStats('MK12 SPR', 'DMR',102, 1, 550, 1, 15, 2600, true, 45, 26, 6, 710, 500, 1200, 0, 0.3, 0.83, 8, 0.84, 0.56, 0.92, 0.5, '#333', 'bullet',4,6,90,12,20, 3, 45, -2),
