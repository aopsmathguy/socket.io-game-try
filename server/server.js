...
var makeObstacles = function() {
    ...
    viableWeapons = [
        ...
        new GunStats('AK-47', 95, true, 600, 1, 30, 1800, true, 55, 12, 2, 600, 400, 1300, 0, 0.15, 0.85, 6, 0.9, 0.93, 0.5, '#bb7554', 'bullet','#ff0',60,16, 24, 3, 50, 0),
        ...
        new GunStats('M1A1', 90, true, 700, 1, 50, 2200, true, 45, 11, 3, 550, 270, 1200, 0, 0.04, 0.96, 5, 0.9, 0.9, 0.5, '#fff', 'bullet','#ff0',60,12,28, 3,47, -9),
