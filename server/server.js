...
var makeObstacles = function() {
    ...
    for (var blah = 0; blah < numOb; blah++) {
        ...
        for (var i = 0; i < resolution; i++) {
            distList[i] = (1 + size) * (10 + 70 * Math.random());
    ...
    var viableWeapons = [
        ...
        new Gun(200, 350, 90, true, 700, 1, 75, 4500, 45, 10, 2, 550, 270, 1500, 0, 0.08, 0.91, 3, 0.9, 0.7, 0.2, '#fff', 20, 3, 45, 6),
        new Gun(200, 350, 90, true, 1500, 1, 100, 2000, 200, 5, 0, 550, 270, 2000, 0, 0, 0.91, 3, 0.9, 0.9, 0.2, '#08f', 20, 3, 45, 6),
