...
var makeObstacles = function() {
    ...
    viableWeapons = [
        ...
        new GunStats('Redhawk', 40, false, 300, 1, 6, 1400,true, 50, 33, 8, 750, 200, 1500, 0, 0.2, 0.9, 10, 0.9, 0.95, 0.6, '#ff0','bullet','#ff0', 60,35, 5, 0, 5, 0),

        new GunStats('MAC-10', 50, true, 1200, 1, 32, 1300, true, 45, 10, 5, 400, 150, 1000, 0.15, 0.08, 0.9, 3, 0.9, 0.97, 0.8, '#08f','bullet', '#ff0',60,20,10, 3, 27, 0),
        new GunStats('MP5', 72, true, 750, 1, 30, 1450, true, 45, 11, 4, 550, 270, 1250, 0, 0.07, 0.91, 4, 0.9, 0.95, 0.65, '#f80','bullet', '#ff0',60,14,26, 3, 46, 0),
        new GunStats('AK-47', 90, true, 600, 1, 30, 1800, true, 55, 12, 1, 600, 400, 1500, 0, 0.13, 0.85, 6, 0.9, 0.93, 0.5, '#bb7554', 'bullet','#ff0',60,16, 24, 3, 44, 0),
        new GunStats('MK11', 90, false, 550, 1, 15, 2000, true, 70, 26, 7, 710, 200, 2000, 0, 0.3, 0.83, 8, 0.84, 0.92, 0.5, '#f08', 'bullet','#ff0',60,20,20, 3, 45, 0),

        new GunStats('M1A1', 90, true, 700, 1, 50, 2200, true, 45, 11, 3, 550, 270, 1250, 0, 0.04, 0.96, 5, 0.9, 0.9, 0.5, '#fff', 'bullet','#ff0',60,12,28, 3,55, 0),
        ...
        new GunStats('Mosin Nagant', 110, false, 60, 1, 5, 1000, false, 70, 70, 20, 830, 240, 3000, 0, 0.3, 0.83, 14, 0.9, 0.9, 0.6, '#8f0', 'bullet','#ff0',60,20,20, 3, 45, 0),
