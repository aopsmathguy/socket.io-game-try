...
var makeObstacles = function() {
    ...
    viableWeapons = [
        ...
        new GunStats('Redhawk', 40, false, 300, 1, 6, 1700,true, 50, 40, 15, 700, 200, 1300, 0, 0.2, 0.9, 10, 0.9, 0.95, 0.6, '#ff0','bullet','#ff0', 60,32, 3, 0, 3, 0),
        ...
        new GunStats('M16A3', 90, true, 700, 1, 30, 3000, true, 60, 13, 1, 650, 270, 1300, 0, 0.07, 0.9, 5, 0.9, 0.93, 0.5, '#888', 'bullet','#ff0',60,12,20, 3,45, -2),
