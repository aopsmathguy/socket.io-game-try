...
var makeObstacles = function() {
    ...
    viableWeapons = [
        new GunStats('M9', 30, false, 780, 1, 15, 1100, true, 40, 17, 4, 500, 150, 1000, 0.1, 0.12, 0.9, 7, 0.9, 0.95, 1, '#80f','bullet','#ff0', 60, 40, 0, 0, 0, 0),
        ...
        new GunStats('MAC-10', 50, true, 1080, 1, 32, 1300, true, 45, 10, 5, 400, 150, 1000, 0.1, 0.08, 0.9, 3, 0.9, 0.97, 0.8, '#f00','bullet', '#ff0',60,20,10, 3, 27, 0),
        ...
        new GunStats('Laser', 110, false, 120, 1, 6, 2200, true,200, 50, 1, 700, 200, 2000, 0, 0, 0.91, 20, 0.9, 0.9, 0.4, '#08f','laser','#08f', 120,20,20, 3, 45, 0),
