...
const words = {
    ...
    randomName : function(){
        return this.adjectives[Math.floor(this.adjectives.length() * Math.random())] + " " + this.nouns[Math.floor(this.nouns.length() * Math.random())];
    }
}
...
const viableWeapons = {
    ...
    start : function()
    {
        this.weapons = [
            ...
            new GunStats('M1A1', 'SMG',90, Infinity, 700, 1, 50, 3100, true, 33.75, 15, 5, 450, 270, 900, 0, 0.04, 0.96, 5, 0.9, 0.3, 0.9, 0.5, '#fff', 'bullet','#ff8',5,60,10,23, 3,48, -9),
            ...
            new GunStats('M4A1', 'Assault', 90, Infinity, 700, 1, 30, 3000, true, 45, 16, 1, 550, 270, 975, 0, 0.07, 0.9, 5, 0.9, 0.48, 0.93, 0.5, '#888', 'bullet','#8f8',6,60,12,20, 3,45, -2),
            new GunStats('M4', 'Assault', 90, 3, 900, 1, 30, 2600, true, 45, 16, 1, 550, 270, 975, 0, 0.035, 0.95, 5, 0.9, 0.48, 0.93, 0.5, '#ccc', 'bullet','#8f8',6,60,12,20, 3,45, -2),
