...
var makeObstacles = function() {
    ...
    viableWeapons = [
        ...
        new GunStats('MP5', 75, true, 750, 1, 30, 1850, true, 45, 11, 4, 550, 270, 1100, 0, 0.07, 0.91, 4, 0.9, 0.95, 0.65, '#f80','bullet', '#ff0',60,14,26, 3, 46, -2),
        new GunStats('AK-47', 95, true, 600, 1, 30, 2300, true, 55, 12, 2, 600, 400, 1300, 0, 0.15, 0.85, 6, 0.9, 0.93, 0.5, '#bb7554', 'bullet','#ff0',60,16, 24, 3, 50, -2),
        new GunStats('MK11', 90, false, 550, 1, 15, 2500, true, 70, 26, 7, 710, 200, 1600, 0, 0.3, 0.83, 8, 0.84, 0.92, 0.5, '#f08', 'bullet','#ff0',60,20,20, 3, 45, -2),
        new GunStats('M1A1', 90, true, 700, 1, 50, 2900, true, 45, 11, 3, 550, 270, 1200, 0, 0.04, 0.96, 5, 0.9, 0.9, 0.5, '#fff', 'bullet','#ff0',60,12,28, 3,48, -9),
        new GunStats('M16A3', 90, true, 700, 1, 30, 2900, true, 60, 12, 1, 650, 270, 1300, 0, 0.07, 0.9, 5, 0.9, 0.93, 0.5, '#888', 'bullet','#ff0',60,20,20, 3,45, -2),
        ...
        new GunStats('Crossbow', 70, false, 9000, 1, 1, 1800, false,25, 100, 0, 830, 240, 1500, 0, 0.3, 0.83, 16, 0.9, 0.9, 1, '#000', 'arrow','#bb7554', 30,20,20, 3, 40, -2),
