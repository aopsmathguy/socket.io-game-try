...
var makeObstacles = function() {
    ...
    var viableWeapons = [
        ...
        new Gun('MAC-10',100, 60, 50, true, 900, 1, 32, 1200, true, 45, 12, 6, 500, 150, 1000, 0, 0.10, 0.9, 3, 0.9, 0.97, 0.8, '#f00', 20,10, 3, 27, 0),
        new Gun('MP5',200, 350, 60, true, 720, 1, 30, 1300, true, 45, 11, 3, 550, 270, 1250, 0, 0.06, 0.91, 4, 0.9, 0.95, 0.65, '#f80', 20,20, 3, 40, 0),
        ...
        new Gun('Crossbow',200, 50, 60, false, 60, 1, 1, 1000, false, 25, 100, 0, 830, 240, 1500, 0, 0.3, 0.83, 17, 0.9, 0.9, 0.8, '#000', 20,20, 3, 45, 0),

        new Gun('Stevens DB',200, 220, 50, false, 450, 8, 2, 1600, true, 35, 15, 9, 350, 56, 700, 0.15, 0, 0.83, 10, 0.9, 1, 0.7, '#f0f', 20,20, 3, 45, 0),
        new Gun('SPAS-12',200, 220, 60, false, 100, 8, 9, 800, false, 40, 8, 1, 650, 100, 1100, 0.1, 0, 0.83, 10, 0.9, 1, 0.5, '#0ff', 20,20, 3, 45, 0)
    ];
